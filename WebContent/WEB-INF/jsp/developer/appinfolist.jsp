...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="/AppInfoSystem/appinfo/appInfoList.do">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/appinfo/goaddappinfo.do" class="btn btn-success btn-sm">新增APP基础信息</a>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							...
							<span id="pageNoNo">${page.getPageNo() }</span>/${page.getPages() }页</div>
					</div>
					<div class="col-sm-7">
							...
							<ul class="pagination">
								<c:if test="${page.getPageNo() > 1}">
									<li class="paginate_button previous"><a
										href="/AppInfoSystem/appinfo/changePage.do?pageNo=1"
										aria-controls="datatable-responsive" data-dt-idx="0"
										tabindex="0">首页</a>
									</li>
									<li class="paginate_button "><a
										href="/AppInfoSystem/appinfo/changePage.do?pageNo=${page.getPrev()}"
								...
								<c:if test="${page.getPageNo() < page.getRows() }">
									<li class="paginate_button "><a
										href="/AppInfoSystem/appinfo/changePage.do?pageNo=${page.getNext() }"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
									</li>
									<li class="paginate_button next"><a
										href="/AppInfoSystem/appinfo/changePage.do?pageNo=${page.getPages() }"
